...
var letters = [''];
var correctLetters = [''];
//Generates a random word then splits into single letters.
function randomWord(){
...
randomWord();
//Display current word with _ before game starts.
var hidden = answer.replace(/[a-z]+/gi, '_ ');
document.getElementById("currentWord").innerHTML = hidden;
console.log(hidden);
